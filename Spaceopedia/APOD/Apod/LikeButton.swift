...
class LikeButton: UIButton {
    ...
    let likedImage: UIImage = UIImage(systemName: "heart.fill")!.applyingSymbolConfiguration(.init(scale: .large))!.withTintColor(UIColor(named: "heartRed")!, renderingMode: .alwaysOriginal)
